...
for (i = 0; i < heartPointsCount; i++) {
    ...
    e[i] = {
        ...
        D: 2 * (i % 2) - 1,
        force: 0.2 * rand() + 0.7,
        // 💙 change color palette to blue shades
        f: "hsla(200," + ~~(40 * rand() + 60) + "%," + ~~(50 * rand() + 30) + "%,.6)",
        trace: []
    };
...
var loop = function () {
    ...
    // ✨ Transparent overlay in light blue to create fading trails
    ctx.fillStyle = "rgba(179,229,252,.2)";
    ctx.fillRect(0, 0, width, height);
